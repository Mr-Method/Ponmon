...
## v2025.11.01 (Поточна версія)

### Важливі зміни
 - виправлено проблему з зупинкою моніторингу OLT при самостійному запуску через `perl _noponmon.pl -o=1`
 - змінено значення параметра `snmp_repeaters` на 0 за замовчуванням, оскільки не всі OLT добре працюють зі snmpbulkwalk (0 - snmpwalk; 1 - snmpbulkwalk; >1 - snmpbulkwalk з кількістю пакетів)
